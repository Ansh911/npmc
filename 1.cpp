...
int runSimulation(double y, double offset)
{
    ...
    float result = 1 / x;
    cout << "When y = " << y << " & Mobile station is @ " << offset << " Offset from Center "<<endl; cout<<" Co -channel interference is "<<result<<"\n\n "; 
    return 0;
}
int main()
{
    ...
    while (option != 0)
    {
        ...
        cout << " 1. At the center (Best Case) "<<endl; cout<<" 2. At R/4 "<<endl; cout<<" 3. At R / 2 "<<endl; cout<<" 4. At 3R / 4 "<<endl; cout<<" 5. At R(Worst Case) "<<endl; cout<<" 0. Exit\n ";
        cin >>option;
        if (option == 0)
        {
            return 0;
